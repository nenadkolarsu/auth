...
<%-- 										<c:param name="page" value="${param.page}" /> --%>
									...
									<c:url value="dokumentStavke_new.html" var="displayURL">
										<c:param name="brDokumenta" value="${param.id}" />
										<c:param name="page" value="${param.page}" />
									</c:url>
								...
								<tbody>
									...
									<c:forEach items="${dokumentStavke}" var="tester">
										<tr>
											...
											<td><a
												href="/update_dokumentStavke.html?id=${tester.id}&brDokumenta=${tester.idDokument.id}"
												class="btn btn-primary eBtn"> Edit</a></td>
											<td><a onClick="return ConfirmDelete();"
												href="/delete_dokumentStavke.html?id=${tester.id}&brDokumenta=${tester.idDokument.id}"
