...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2017 at 07:20 AM
...
(8, NULL, b'1111111111111111111111111111111', '3', NULL, NULL, 'Jaje', '', NULL, '2017-12-10 17:38:42', NULL, NULL, NULL, 1, 2, 1, 1);
...
--
-- Table structure for table `ptt_brijevi`
--

DROP TABLE IF EXISTS `ptt_brijevi`;
CREATE TABLE `ptt_brijevi` (
  `id` bigint(20) NOT NULL,
  `akcija` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `aktivan` bit(1) DEFAULT NULL,
  `code` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Indexes for table `ptt_brijevi`
--
ALTER TABLE `ptt_brijevi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_q3rs46703yvqae0gcnp0xtsq4` (`ptt_brojevi_id`);
...
--
-- AUTO_INCREMENT for table `ptt_brijevi`
--
ALTER TABLE `ptt_brijevi`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `ptt_brijevi`
--
ALTER TABLE `ptt_brijevi`
  ADD CONSTRAINT `FK_q3rs46703yvqae0gcnp0xtsq4` FOREIGN KEY (`ptt_brojevi_id`) REFERENCES `drzave` (`id`);
